/* Auto-generated Q10 atan table for ANGLES=1024. */
/* atan_q10_lut[i] = round(atan(i/256) * 1024 / (2*pi)), i in 0..256. */
/* Range [0..128] = [0..pi/4] in our Q10 angle space. */
#define ATAN_LUT_N 256
static const int __far atan_q10_lut[ATAN_LUT_N + 1] = {
        0,     1,     1,     2,     3,     3,     4,     4,
        5,     6,     6,     7,     8,     8,     9,    10,
